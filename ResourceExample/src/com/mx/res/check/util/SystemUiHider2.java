 ...
 */
public abstract class SystemUiHider2 {
	/**
	...
	/**
	 * Creates and returns an instance of {@link SystemUiHider2} that is
	 ...
	 */
	public static SystemUiHider2 getInstance(Activity activity, View anchorView,
			int flags) {
...
//		}
	...
	protected SystemUiHider2(Activity activity, View anchorView, int flags) {
		mActivity = activity;
